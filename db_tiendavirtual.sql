...
-- Tiempo de generación: 26-07-2021 a las 22:12:27
...
CREATE TABLE IF NOT EXISTS `persona` (
  ...
  `identificacion` varchar(50) COLLATE utf8mb4_swedish_ci NOT NULL,
  `nombres` varchar(80) COLLATE utf8mb4_swedish_ci NOT NULL,
  `apellidos` varchar(100) COLLATE utf8mb4_swedish_ci NOT NULL,
  `telefono` bigint NOT NULL,
  `email_user` varchar(100) COLLATE utf8mb4_swedish_ci NOT NULL,
  `password` varchar(25) COLLATE utf8mb4_swedish_ci NOT NULL,
  `rtn` varchar(20) COLLATE utf8mb4_swedish_ci NOT NULL,
  `nombrefical` varchar(80) COLLATE utf8mb4_swedish_ci NOT NULL,
  `dirrecionfiscal` varchar(100) COLLATE utf8mb4_swedish_ci NOT NULL,
